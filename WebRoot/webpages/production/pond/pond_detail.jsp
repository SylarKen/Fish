	...
	<form id="fond_edit_form" method="post" action='${basePath}pond/editSave' >
		...
		<tr style="height:40px;">
			<td style="width:360px;text-align:left;">池塘名称：
				<input disabled  id="name" class="easyui-textbox" name="name" value='${ bean.name }' 
					data-options="required:true" style="width:280px;" validType="validator">
			</td>		
		</tr>
		<tr style="height:40px;">
			<td style="width:360px;text-align:left;">池塘面积：
				<input disabled  id="area" class="easyui-textbox" name="area" value='${ bean.area }' 
					data-options="required:true" style="width:280px;" validType="validator">
			</td>
		...
		<tr style="height:80px;">
			<td style="width:360px;text-align:left;">主要养殖品种：</br>
				<textarea disabled id = "fishinfo" name="fishinfo" rows="3" style="width:360px;line-height:25px;"  validType="validator">${ bean.fishinfo }</textarea>
			</td>
		
		</tr>
		<tr style="height:40px;">
			<td style="width:360px;text-align:left;">位置：</br>
				<textarea disabled id = "location"  name="location" rows="3" style="width:360px;line-height:25px;"  validType="validator">${ bean.location }</textarea>
			</td>
		</tr>
		
		<tr style="height:40px;">
			<td style="width:360px;text-align:left;">联系人员：
				<input disabled id="linkman" class="easyui-textbox" name="linkman" value='${ bean.linkman }' 
					data-options="required:true" style="width:280px;" validType="validator">
			</td>
		...
		<tr style="height:40px;">
			<td style="width:360px;text-align:left;">联系电话：
				<input disabled id="contactway" class="easyui-textbox" name="contactway" value='${ bean.contactway }' 
					data-options="required:true" style="width:280px;" validType="validator">
			</td>
		</tr>
